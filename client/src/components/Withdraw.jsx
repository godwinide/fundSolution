...
const Withdraw = ({getCustomers, getHistory}) => {
    ...
    const deposit = async() => {
        try{
            ...
            const res = await axios.post("/withdraw", data, tokenConfig(store.getState));
            setLoading(false);
                                        ...
                                        <div>
                                            {
                                                ...
                                                >
                                                    <span id="payment-button-amount">Withdrawing..</span>
                                                </button>
                                                :<button 
                                                    id="payment-button" type="submit" 
...
export default connect(null, {getCustomers, getHistory})(Withdraw)
